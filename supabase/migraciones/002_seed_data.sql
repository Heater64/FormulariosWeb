...
-- Perfiles de desarrollo sin credenciales conocidas. Estos valores aleatorios
-- no permiten iniciar sesión; las cuentas reales se crean mediante Supabase Auth.
INSERT INTO perfiles (username, password, nombre_completo, rol) VALUES
('owner',  encode(gen_random_bytes(32), 'hex'), 'Propietario',    'owner'),
('admin1', encode(gen_random_bytes(32), 'hex'), 'Admin Central',  'admin'),
('editor1',encode(gen_random_bytes(32), 'hex'), 'Editor Demo',    'editor'),
('alumno', encode(gen_random_bytes(32), 'hex'), 'Alumno Demo',    'usuario'),
('usuario',encode(gen_random_bytes(32), 'hex'), 'Usuario Demo',    'usuario')
