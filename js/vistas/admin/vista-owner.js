    ...
    _renderizar(raiz, { stats, auditoria, grupos, examenes, usuario }) {
      raiz.innerHTML = `
        <div class="o-contenedor o-pila o-pila--lg" style="padding-top:var(--espaciado-lg);padding-bottom:100px">
          <div class="o-flecha o-flecha--between"><h2>${window.Iconos.render('building-2')} Panel de Propietario</h2><button class="btn-secundario" onclick="router.navegar('/perfil')">← Volver</button></div>
          ...
          <div class="o-pila"><h3>${window.Iconos.render('file-text')} Todos los exámenes (${examenes.length})</h3>
          ...
          <div class="o-pila"><h3>${window.Iconos.render('clipboard-list')} Auditoría (últimas ${auditoria.length})</h3>
